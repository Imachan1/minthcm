...
$js_groupings = array(
   ...
   'include/Dropzone/Files.js' => 'include/javascript/sugar_grp1.js',
   'include/Dropzone/PhotosFiles.js' => 'include/javascript/sugar_grp1.js',
   'include/Dropzone/DocumentFiles.js' => 'include/javascript/sugar_grp1.js',
   ),
   //jquery libraries
...
if ( isset($GLOBALS['sugar_config']['developerMode']) && $GLOBALS['sugar_config']['developerMode'] ) {
   $sugar_grp1 = array_merge($sugar_grp1, array(
      '/include/ViewTools/javascript/viewTools_developermode.js' => $group_file_name1,
   ));
} else {
   $sugar_grp1 = array_merge($sugar_grp1, array(
      '/include/ViewTools/javascript/viewTools.js' => $group_file_name1,
      '/include/ViewTools/javascript/viewTools.cache.js' => $group_file_name1,
      '/include/ViewTools/javascript/viewTools.init.js' => $group_file_name1,
