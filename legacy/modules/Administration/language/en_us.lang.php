...
$mod_strings = array(
   ...
   'ERR_CREDENTIALS_MISSING' => 'Your MintHCM credentials are missing.',
   ...
   'HDR_LOGIN_PANEL' => 'Please enter your MintHCM Login credentials.',
   'HEARTBEAT_MESSAGE' => "<BR>The MintHCM Updates mechanism allows your server to check to see if an update for your version of MintHCM is available.",
   ...
   'LBL_BACKUP_DIRECTORY_WRITABLE' => 'Must be writable by MintHCM',
   ...
   'LBL_BACKUP_INSTRUCTIONS_1' => 'The purpose of this tool is to assist in creating backups of the MintHCM application files. (Database backups should also be performed regularly. Please refer to your database vendor\'s documentation for information on how to backup your database.)',
   'LBL_BACKUP_INSTRUCTIONS_2' => 'To backup your MintHCM application files in a .zip file, enter the following information:',
   'LBL_BACKUP_RUN_BACKUP' => 'Run Backup',
   'LBL_BACKUPS_TITLE' => 'Backups',
   'LBL_BACKUPS' => 'Backup MintHCM files',
   'LBL_BUG_TITLE' => 'Bugs',
   ...
   'LBL_COULD_NOT_CONNECT' => 'Error: Could not connect to the MintHCM Server.
   ...
   'LBL_DIAGNOSTIC_CONFIGPHP' => 'MintHCM config.php',
   'LBL_DIAGNOSTIC_CUSTOMDIR' => 'MintHCM Custom directory',
   ...
   'LBL_DIAGNOSTIC_GETSUITELOG' => 'Getting minthcm.log',
   ...
   'LBL_DIAGNOSTIC_SUITELOG' => 'MintHCM Log File',
   'LBL_DIAGNOSTIC_TITLE' => 'Diagnostic Tool',
   'LBL_DIAGNOSTIC_VARDEFS' => 'MintHCM schema output (VARDEFS)',
   ...
   'LBL_LDAP_HELP_TXT' => 'When LDAP authentication is enabled, passwords can only be handled through LDAP. None of the MintHCM Password Management feature settings will apply.',
   ...
   'LBL_LDAP_GROUP_NAME_DESC' => 'Example cn=MintHCM',
   ...
   'LBL_MI_IN_DASHLETS' => 'Installing MintHCM Dashlet ',
   'LBL_MI_UN_DASHLETS' => 'Uninstalling MintHCM Dashlet ',
   ...
   'LBL_MODULE_LOADER' => 'Add or remove MintHCM modules, themes, language packs and other extensions',
   ...
   'LBL_PROXY_ON_DESC' => 'Use a proxy to access external information such as MintHCM updates.',
   ...
   'LBL_REBUILD_DASHLETS_DESC_SHORT' => 'Rebuilds the MintHCM Dashlets cache file',
   'LBL_REBUILD_DASHLETS_DESC_SUCCESS' => 'MintHCM Dashlets cache file rebuilt.',
   'LBL_REBUILD_DASHLETS_DESC' => 'Removing MintHCM Dashlets cache and scanning known directories for MintHCM Dashlet files.',
   'LBL_REBUILD_DASHLETS_TITLE' => 'Rebuild MintHCM Dashlets',
   ...
   'LBL_RETURN' => 'Return',
   'LBL_SEND_STAT' => '<B>Send Anonymous Usage Statistics</B> - If checked, it will send anonymous statistics about your installation to MintHCM. every time your system checks for new versions. This information will help us better understand how the application is used and guide improvements to the product.',
   ...
   'LBL_SUITE_UPDATE_TITLE' => 'MintHCM Updates',
   ...
   'LBL_UPDATE_TITLE' => 'MintHCM Updates',
   'LBL_UPGRADE_TITLE' => 'Repair',
   'LBL_UPGRADE_WIZARD_TITLE' => 'Upgrade Wizard',
   'LBL_UPGRADE_WIZARD' => 'Upload and install MintHCM upgrades',
   'LBL_UPGRADE' => 'Check and repair MintHCM',
   ...
   'LBL_USERS_DESC' => 'Create, edit, activate and deactivate users in MintHCM.',
   ...
   'LBL_MODULEBUILDER_DESC' => 'Build new modules to expand the functionality of MintHCM',
   'LBL_SUITEPORTAL' => 'MintHCM Portal',
   ...
   'LBL_QR_CBOX_CLEARDASHLET' => 'Clear MintHCM Dashlet Cache Data',
   ...
   'LBL_QR_CBOX_CLEARSUITEFEEDCACHE' => 'Clear MintHCM Feed Cache',
   'LBL_QR_CLEARSUITEFEEDCACHE' => 'Clearing MintHCM Feed Cache...done',
   ...
   'ML_RELAX_LOCAL' => 'If you are running MintHCM locally, you can relax your Module Loader restrictions to allow the package to be installed.',
   'ML_SUITE_KB' => 'MintHCM Knowledge Base',
   ...
   'LBL_SAML_HELP_TXT' => 'When SAML authentication is enabled, passwords can only be handled through SAML. None of the MintHCM Password Management feature settings will apply.',
   ...
   'LBL_GOOGLE_SUITE_ADMIN_HEADER' => 'Google Apps',
   'LBL_GOOGLE_SUITE_ADMIN_DESC' => 'Manage your Google Apps Integration.',
   ...
   'LBL_MANAGE_SECURITYGROUPS_TITLE' => 'Organizational Units Management',
   'LBL_MANAGE_SECURITYGROUPS' => 'Organizational Units Editor',
   'LBL_CONFIG_SECURITYGROUPS_TITLE' => 'Organizational Units Settings',
   'LBL_CONFIG_SECURITYGROUPS' => 'Configure Organizational Units settings such as inheritance, additive security, etc',
   ...
   'LBL_ELASTIC_SEARCH_SETTINGS_HELP' => 'Elasticsearch requires an external server set up to work. Read the <a href="https://minthcm.org/documentation/">documentation</a> to learn how.',
   ...
   'LBL_PRIVATE_GROUP' => 'Private Security Groups',
   'LBL_PRIVATE_GROUP_REPAIR' => 'Repair Private Security Groups',
   'LBL_PRIVATE_GROUP_REPAIR_DESCRIPTION' => 'Repair Private Security Groups',
   'LBL_REPAIR_PRIVATE_GROUP_STATUS_BOX_SUCCESS' => 'Repair added to queue',
   'LBL_REPAIR_PRIVATE_GROUP_STATUS_BOX_FAIL' => 'Failed adding repair to queue',
   'LBL_DEL_ADMIN_MODULES' => 'Delegations',
   'LBL_DEL_MODULENAME' => 'Delegations Locale',
   'LBL_CONFIGURE_REBUILD_VIEWTOOLS_TITLE' => 'Rebuild View Tools',
   'LBL_CONFIGURE_REBUILD_VIEWTOOLS' => 'Rebuild scripts used by View Tools',
   'LBL_DASHBOARD_MANAGEMENT' => 'Dashboard Management',
   'LBL_DASHBOARD_MANAGER' => 'Dashboard Manager',
   'LBL_DASHBOARD_MANAGER_DESCRIPTION' => 'Manage dashboard templates',
   'LBL_DASHBOARD_BACKUPS' => 'Dashboard Backups',
   'LBL_DASHBOARD_BACKUPS_DESCRIPTION' => 'Manage dashboard backups',
   'LBL_DASHBOARD_HISTORY' => 'Dashboard Deployment History',
   'LBL_DASHBOARD_HISTORY_DESCRIPTION' => 'Show dashboard deployments history',
   'LBL_GENERATOR' => "Repair PDF buttons",
   ...
   // DLNC start
   'LBL_ADD_LAST_NEXT_CONTACT_PANEL' => 'Add last next contact panels',
   'LBL_ADD_LAST_NEXT_CONTACT_PANEL_DESCRIPTION' => 'This action add last next contact panels to specific modules',
   'LBL_ADD_LAST_NEXT_CONTACT_PANEL_SUCCESS' => 'Panel was successfully added.',
   'LBL_DLNC_MISSING_CONFIG_FILE' => 'Missing Date Last Next Contact config file.',
   'LBL_ADD_LAST_NEXT_CONTACT_TABS' => 'Add last next contact tabs',
   'LBL_ADD_LAST_NEXT_CONTACT_TABS_DESCRIPTION' => 'This action add last next contact tabs to specific modules',
   'LBL_ADD_LAST_NEXT_CONTACT_TABS_SUCCESS' => 'Tabs was successfully added.',
   'LBL_DLNC_SETTINGS' => 'Include only owner activities',
   'LBL_DLNC_SETTINGS_DESCRIPTION' => 'Include only owner activities',
   'LBL_DLNC_SETTINGS_SUCCESS' => 'Owner activities included.',
   'LBL_DLNC_CHECKBOX' => 'Include only owner activities',
   'LBL_BUTTON_SAVE_CONFIG' => 'Save',
   'LBL_CALCULATE_DLNC_ALERT' => 'Recalculation complete',
   'LBL_CALCULATE_DLNC_ONLY_NULL_RECORDS' => 'Only uncalculated records',
   'LBL_CALCULATE_DLNC_BUTTON_CALCULATE' => 'Calculate',
   'LBL_CALCULATE_DLNC_FOOTER' => 'Converting Date Last Next Contact',
