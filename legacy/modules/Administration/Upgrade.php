...
<table class="other view">
    ...
    <?php } ?>
    <tr>
        <td scope="row"><?php echo SugarThemeRegistry::current()->getImage('Rebuild', 'align="absmiddle" border="0"', null, null, '.gif', $mod_strings['LBL_CONFIGURE_REBUILD_VIEWTOOLS_TITLE']); ?>&nbsp;<a href="./index.php?module=Administration&action=RebuildViewTools"><?php echo $mod_strings['LBL_CONFIGURE_REBUILD_VIEWTOOLS_TITLE']; ?></a></td>
        <td> <?php echo $mod_strings['LBL_CONFIGURE_REBUILD_VIEWTOOLS']; ?> </td>
    </tr>
    <tr>
