...
require_once 'modules/Candidates/Candidates.php';
require_once 'include/Sugar_Smarty.php';

class CandidatesViewShowduplicates extends SugarView
{
    protected $module_name = "Candidates";
    protected $object_name = "Candidates";
    ...
    {
        global $mod_strings;
        $employee_label = !empty($mod_strings['LBL_EMPLOYEES_MODULE_DUP']) ? $mod_strings['LBL_EMPLOYEES_MODULE_DUP'] : 'Employees';
        $candidate_label = !empty($mod_strings['LBL_MODULE_NAME']) ? $mod_strings['LBL_MODULE_NAME'] : 'Candidates';
