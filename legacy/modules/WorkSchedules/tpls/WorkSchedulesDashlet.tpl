		...
		<tr height='20' class='{$_rowColor}S1'>
			...
			<td width='1%' class='{$_rowColor}S1' bgcolor='{$_bgColor}' nowrap>
                ...
                {if isset($show_accept_button[$id]) && $show_accept_button[$id] == true}
                    <a class="list-view-data-icon" href="javascript:void(0)" onclick="acceptWorkPlanForDashlet('{$data[$id].ID}');" title="{sugar_translate label="LBL_VIEW_INLINE"}"> <span class="suitepicon suitepicon-action-confirm"></span></a>
                {/if}
			</td>
			{/if}
	    	</tr>
