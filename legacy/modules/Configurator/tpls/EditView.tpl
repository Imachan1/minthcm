...
<form name="ConfigureSettings" enctype='multipart/form-data' method="POST" action="index.php" onSubmit="return (add_checks( document.ConfigureSettings ) && check_form( 'ConfigureSettings' ));">
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        ...
        <tr>
            ...
            <!--View Tools start #59582 -->
            <td scope="row" width='15%' nowrap>{$MOD.LBL_SUBPANEL_COUNT_METHOD}:</td>
            <td width='35%'>
                <select name='subpanel_count_method' id='subpanel_count_method'>{$SUBPANEL_COUNT_METHODS}</select>
            </td>
            <!--View Tools end #59582 -->
        </tr>
...
{if $error.company_logo}
    <script type='text/javascript'>
        {literal}$( function () {
               alert( '{/literal}{$error.company_logo}{literal}' );} );{/literal}
        </script>
        {/if}
            {literal}
                <script type='text/javascript'>
