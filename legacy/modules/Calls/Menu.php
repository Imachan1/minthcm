...
if (ACLController::checkAccess('Calls', 'list', true)) $module_menu[] = array("index.php?module=Calls&action=index&return_module=Calls&return_action=DetailView", $mod_strings['LNK_CALL_LIST'], "List");
...
if (ACLController::checkAccess('Calls', 'list', true)) $module_menu[] = array("index.php?module=Calls&action=ESListView", $mod_strings['LNK_ES_CALLS_LIST'], "List");
