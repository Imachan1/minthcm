...
$mod_strings = array(
    ...
    'help' => array(
        ...
        'module' => array(
            ...
            'type_person' => 'The <b>Person</b> template type provides individual-specific fields, such as Salutation, Title, Name, Address and Phone Number.<br/><br/>Use this template to create modules that are similar to the standard Contacts module.',
        ...
        'studioWizard' => array(
            ...
            'sugarPortalBtn' => 'Use <b>MintHCM Portal Editor</b> to manage and customize the MintHCM Portal.',
            ...
            'portalBtn' => 'Customize the module <b>Layouts</b> that appear in the <b>MintHCM Portal</b>.',
            ...
            'viewBtnDashlet' => 'Customize the module\'s <b>MintHCM Dashlet</b>, including the MintHCM Dashlet\'s ListView and Search.<br><br>The MintHCM Dashlet will be available to add to the pages in the Home module.',
            ...
            'dashletHelp' => 'The <b>MintHCM Dashlet</b> layouts that can be customized appear here.<br><br>The MintHCM Dashlet will be available to add to the pages in the Home module.',
            'DashletListViewBtn' => 'The <b>MintHCM Dashlet ListView</b> displays records based on the MintHCM Dashlet search filters.',
            'DashletSearchViewBtn' => 'The <b>MintHCM Dashlet Search</b> filters records for the MintHCM Dashlet listview.',
            ...
            'portalHelp' => 'Manage and customize the <b>MintHCM Portal</b>.',
            'SPUploadCSS' => 'Upload a <b>Style Sheet</b> for the MintHCM Portal.',
            'SPSync' => '<b>Sync</b> customizations to the MintHCM Portal instance.',
            'Layouts' => 'Customize the <b>Layouts</b> of the MintHCM Portal modules.',
            'portalLayoutHelp' => 'The modules within the MintHCM Portal appear in this area.<br><br>Select a module to edit the <b>Layouts</b>.',
        ...
        'portalSync' => array(
            'default' => 'Enter the <b>MintHCM Portal URL</b> of the portal instance to update, and click <b>Go</b>.<br><br>Then enter a valid MintHCM user name and password, and then click <b>Begin Sync</b>.<br><br>The customizations made to the MintHCM Portal <b>Layouts</b>, along with the <b>Style Sheet</b> if one was uploaded, will be transferred to specified the portal instance.',
        ),
        'portalStyle' => array(
            'default' => 'You can customize the look of the MintHCM Portal by using a style sheet.<br><br>Select a <b>Style Sheet</b> to upload.<br><br>The style sheet will be implemented in the MintHCM Portal the next time a sync is performed.',
        ),
    ),
    ...
    'assistantHelp' => array(
        'package' => array(
            ...
            'afterSave' => 'Your new package should contain at least one module. You can create one or more custom modules for the package.<br/><br/>Click <b>New Module</b> to create a custom module for this package.<br/><br/> After creating at least one module, you can publish or deploy the package to make it available for your instance and/or other users\' instances.<br/><br/> To deploy the package in one step within your MintHCM instance, click <b>Deploy</b>.<br><br>Click <b>Publish</b> to save the package as a .zip file. After the .zip file is saved to your system, use the <b>Module Loader</b> to upload and install the package within your MintHCM instance. <br/><br/>You can distribute the file to other users to upload and install within their own MintHCM instances.',
        ...
        'module' => array(
            'somemodules' => "Since the current package contains at least one module, you can <b>Deploy</b> the modules in the package within your MintHCM instance or <b>Publish</b> the package to be installed in the current MintHCM instance or another instance using the <b>Module Loader</b>.<br/><br/>To install the package directly within your MintHCM instance, click <b>Deploy</b>.<br><br>To create a .zip file for the package that can be loaded and installed within the current MintHCM instance and other instances using the <b>Module Loader</b>, click <b>Publish</b>.<br/><br/> You can build the modules for this package in stages, and publish or deploy when you are ready to do so. <br/><br/>After publishing or deploying a package, you can make changes to the package properties and customize the modules further. Then re-publish or re-deploy the package to apply the changes.",
...
//STUDIO2
    ...
    'LBL_SUITEPORTAL' => 'MintHCM Portal Editor',
    ...
    'LBL_DASHLET' => 'MintHCM Dashlet',
    'LBL_DASHLETLISTVIEW' => 'MintHCM Dashlet ListView',
    'LBL_POPUP' => 'Popup View',
    'LBL_POPUPLISTVIEW' => 'Popup ListView',
    'LBL_POPUPSEARCH' => 'Popup Search',
    'LBL_DASHLETSEARCHVIEW' => 'MintHCM Dashlet Search',
