...
{
    return <<<HTML
        <iframe id='comments-widget' src='../#/comments/{$bean->module_name}/{$bean->id}' style='border:none;height: 1500px; width: 1000px'></iframe>
        <script>
            ...
            document.querySelector('#comments-widget')?.addEventListener('load', () => {
                ...
                setInterval(resizeCommentsWidget, 250)
            })
        </script>
    HTML;
}
