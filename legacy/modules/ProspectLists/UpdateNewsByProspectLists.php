...
class UpdateNewsByProspectLists
{
    ...
    private $private_security_group_id_of_user = [];
    ...
    protected function updateSecurityGroupsForProspectList($news_id, array $target_employees)
    {
        ...
        $current_security_groups = $news->SecurityGroups->get();
        $target_security_groups = [];
        foreach ($target_employees as $employee_id) {
            $target_security_groups[] = $this->getPrivateSGIDOfUser($employee_id);
        }
    ...
    private function getPrivateSGIDOfUser($user_id)
    {
        if (isset($this->private_security_group_id_of_user[$user_id])) {
            return $this->private_security_group_id_of_user[$user_id];
        }
        $user = BeanFactory::getBean('Users', $user_id);
        if (empty($user->id)) {
            return null;
        }
        $this->private_security_group_id_of_user[$user_id] = $user->getUserPrivateGroup();
        return $this->private_security_group_id_of_user[$user_id];
    }
    ...
    protected function updateUserNewsToListOfEmployees($news_id, $target_employees)
    {
        ...
        $this->updateSecurityGroupsForProspectList($news_id, $target_employees);
    }
