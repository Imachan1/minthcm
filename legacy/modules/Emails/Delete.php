...
if ($email_type == 'archived') {
    ...
    $loc = 'Location: index.php?module='.$_REQUEST['return_module'].'&action='.$_REQUEST['return_action'].'&record='.$_REQUEST['return_id'].'&type='.$emailType.'&assigned_user_id='.$_REQUEST['assigned_user_id'];
}
