...
"5. Click on the Import option from the Actions menu in the application and choose the file to upload"
   ',
    ...
    'LBL_CONFIRM_OPT_IN_ONLY_FOR_PERSON' => 'Confirm Opt In Email sending only for Contacts/Prospects',
...
$app_strings['LBL_UNIFIED_SEARCH_COLUMN_NAME'] = 'Name';
$app_strings['LBL_UNIFIED_SEARCH_COLUMN_MODULE'] = 'Module';
...
$app_strings['LBL_SCHEDULER_PANEL_TITLE'] = 'Availability';
$app_strings['LBL_SCHEDULER_CURRENTLY_PLANNING'] = 'currently planning';
$app_strings['LBL_SCHEDULER_NO_PARTICIPANTS'] = 'No participants';
$app_strings['LBL_SCHEDULER_INVALID'] = 'Invalid time range';
...
$app_strings['LBL_KUDOS_NAVBAR_ITEM_RECEIVED'] = 'Received';
$app_strings['LBL_KUDOS_NAVBAR_ITEM_GIVEN'] = 'Given';
$app_strings['LBL_KUDOS_NAVBAR_ITEM_ALL_COMMENT'] = 'View all kudos you have given and received';
$app_strings['LBL_KUDOS_NAVBAR_ITEM_RECEIVED_COMMENT'] = 'View all received kudos';
$app_strings['LBL_KUDOS_NAVBAR_ITEM_GIVEN_COMMENT'] = 'View all kudos you have given';
$app_strings['LBL_GIVE_KUDOS'] = 'Give Kudos';
$app_strings['LBL_GIVE_KUDOS_COMMENT'] = 'Recognize an employee effort by giving them kudos';
$app_strings['LBL_MINT_QUICK_CREATE'] = 'Quick Create';
$app_strings['LBL_MINT_QUICK_CREATE_COMMENT'] = 'Quickly create records in various modules';
$app_strings['LBL_MINT_ALL_MODULES'] = 'All Modules';
$app_strings['LBL_MINT_ALL_MODULES_COMMENT'] = 'View all modules in the application';
$app_strings['LBL_MINT_ALERTS'] = 'View Alerts';
$app_strings['LBL_MINT_ALERTS_COMMENT'] = 'View all your alerts in one place';
$app_strings['LBL_MINT4_FIND_MODULE_COMMENT'] = 'Find and access any module in the application';
$app_strings['LBL_MINT4_RECENTLY_VIEWED_COMMENT'] = 'Access records you recently viewed';
$app_strings['LBL_MINT4_FAVORITE_RECORDS_COMMENT'] = 'Access records you marked as favorites';
$app_strings['LBL_MINT_TOGGLE_SIDE_MENU'] = 'Toggle Side Menu';
$app_strings['LBL_MINT_TOGGLE_SIDE_MENU_COMMENT'] = 'Expand or collapse the side menu for easier navigation';
$app_strings['LBL_GLOBAL_SEARCH_INPUT'] = 'Search...';
$app_strings['LBL_GLOBAL_SEARCH_INPUT_COMMENT'] = 'Search for records across all modules';
$app_strings['LBL_CLOSE_DRAWER'] = 'Close Drawer';
$app_strings['LBL_CLOSE_DRAWER_COMMENT'] = 'Close the side drawer to return to the main view';
$app_strings['LBL_SCHEDULER_SEARCH_BAR_COMMENT'] = 'Search for participants by name or email';
$app_strings['LBL_KUDOS_DRAWER'] = 'Kudos Drawer';
