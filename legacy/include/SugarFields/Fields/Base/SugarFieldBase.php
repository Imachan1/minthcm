...
class SugarFieldBase {
   ...
   public function displayFromFunc($displayType, $parentFieldArray, $vardef, $displayParams, $tabindex = 0) {
      ...
      if ( $displayType === 'ListView' || $displayType === 'popupView' || $displayType === 'searchView'
      ) {
         ...
         if ( $onListView ) {
            ...
            return $funcName(
                    $parentFieldArray, $vardef['name'], $parentFieldArray[strtoupper($vardef['name'])], $displayType
            );
         } else {
   ...
   public function setup($parentFieldArray, $vardef, $displayParams, $tabindex, $twopass = true) {
      ...
      // View Tools start #40728
      if ( isset($vardef['vt_validation']) && is_array($vardef['vt_validation']) && !isset($vardef['vt_validation']['name']) ) {
         $vardef['vt_validation'] = implode(';', $vardef['vt_validation']);
      }
      // View Tools end #40728
