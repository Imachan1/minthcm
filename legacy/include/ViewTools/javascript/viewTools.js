if ( window.viewTools === undefined ) {
 ...
 window.viewTools.form = {
    ...
    hideRemoveButtonsEmail:function(){
         $(".email-address-input-group").children(".input-group-btn").hide();
         $(".email-address-input-group").width("90%");
    },
    showRemoveButtonsEmail:function(){
         $(".email-address-input-group").children(".input-group-btn").show();
         $(".email-address-input-group").width("unset");
    }
 };
