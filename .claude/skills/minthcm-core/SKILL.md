...
| **Vardefs syntax, field types, relationships, templates** | [vardefs-reference.md](references/vardefs-reference.md) |
| Doctrine entities, repositories, QueryBuilder, EntityManager | [data-layer.md](references/data-layer.md) |
...
| **Field placement: which fields go where on views** | [views-standards.md](references/views-standards.md) |
