      ...
      if ( $checked_field['type'] === 'relate' ) {
         ...
         if ( isset($target_link) && isset($target_bean) ) {
            ...
            foreach ( $target_field_defs as $key => $value ) {
               if ( ($target_field_defs[$value['link']]['relationship'] === $target_link && strtolower($value['type']) === 'relate' ) ) {
         ...
         global $app_list_strings;
         if ( isset($this->bean->field_defs['parent_name']) && isset($this->bean->field_defs['parent_name']['options']) && isset($app_list_strings[$this->bean->field_defs['parent_name']['options']]) && array_key_exists($_REQUEST['parent_type'], $app_list_strings[$this->bean->field_defs['parent_name']['options']]) ) {
            return true;
         }
         return false;
      }
...
function ev_getEmailTemplateArray() {
...
function getKReportsArrayList($bean = null, $field_name = null, $value = null, $view = null) {
