...
<textarea  id='{{$idname}}' class="vt_formulaSelector{{if $vardef.vt_enforced!='false' and $vardef.vt_calculated!=''}} vt_enforced{{/if}}" name='{{$idname}}'
           ...
           {{include file='include/SugarFields/include/formulaInclude.tpl'}}>{$value}</textarea>
