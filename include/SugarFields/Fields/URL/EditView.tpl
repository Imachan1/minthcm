...
{{if !$vardef.gen}}
{if !empty({{sugarvar key='value' string=true}})}
    <input type='text' name='{{$idname}}' class="vt_formulaSelector{{if $vardef.vt_enforced!='false' and $vardef.vt_calculated!=''}} vt_enforced{{/if}}" id='{{$idname}}' size='{{$displayParams.size|default:30}}' 
