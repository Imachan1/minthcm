...
/**
 * Mint #52883
 * changed return function for DashboardManager, which allows us to refresh other subpanels on detail view
 */
...
class SugarWidgetSubPanelTopSelectButtonForDM extends SugarWidgetSubPanelTopSelectButton {
   ...
   public function display($widget_data, $additionalFormFields = NULL, $nonbutton = false) {
      ...
      $popup_request_data = array(
         ...
         'call_back_function' => 'set_return_and_reload_subpanels',
         // Mint end #52883
