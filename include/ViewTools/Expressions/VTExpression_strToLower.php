...
/**
 * Sets lowercase to entered string.
 * EOU:
 * "strToLower( 'Ala Ma Kota' )" will give us "ala ma kota"
 */
class VTExpression_strToLower extends VTExpression {
   ...
   public function backend($arguments = array()) {
      return strtolower(( string ) $arguments['string']);
   }
