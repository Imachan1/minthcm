...
if ( ACLController::checkAccess($module_name, 'edit', true) ) {
   $module_menu[] = array(
      'index.php?module=Contracts&action=EditView&return_module=Contracts&return_action=DetailView',
...
if ( ACLController::checkAccess($module_name, 'list', true) ) {
   $module_menu[] = array(
      'index.php?module=Contracts&action=index&return_module=Contracts&return_action=DetailView',
