...
$mod_strings = array(
   ...
   'LBL_LIST_FORM_TITLE' => 'Organizational Units List',
   'LBL_MODULE_NAME' => 'Organizational Units',
   'LBL_MODULE_TITLE' => 'Organizational Units',
   'LBL_HOMEPAGE_TITLE' => 'My Organizational Units',
   'LNK_NEW_RECORD' => 'Create Organizational Unit',
   'LNK_LIST' => 'View Organizational Units',
   'LNK_IMPORT_ORGANIZATIONALUNITS' => 'Import Organizational Units',
   'LBL_SEARCH_FORM_TITLE' => 'Search Organizational Units',
   'LBL_HISTORY_SUBPANEL_TITLE' => 'View History',
   'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Activities',
   'LBL_ORGANIZATIONALUNITS_SUBPANEL_TITLE' => 'Child Units',
   'LBL_NEW_FORM_TITLE' => 'New Organizationalal Unit',
   'LBL_TYPE' => 'Type',
