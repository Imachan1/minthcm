         ...
         array(
            ...
            array(
               array(
                  ...
                  'customCode' => '<input type="text" name="{$fields.organizationalunit_name.name}" class="sqsEnabled" tabindex="0" id="{$fields.organizationalunit_name.name}" size="" value="{$fields.organizationalunit_name.value}" title="" autocomplete="off" >{$REPORTS_TO_JS}<input type="hidden" name="{$fields.organizationalunit_id.name}" id="{$fields.organizationalunit_id.name}" value="{$fields.organizationalunit_id.value}"> <span class="id-ff multiple"><button type="button" name="btn_{$fields.organizationalunit_name.name}" tabindex="0" title="{$APP.LBL_SELECT_BUTTON_TITLE}" class="button firstChild" value="{$APP.LBL_SELECT_BUTTON_LABEL}" onclick=\'open_popup("{$fields.organizationalunit_name.module}", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"organizationalunit_id","name":"organizationalunit_name"}}{/literal}, "single", true);\'><span class="suitepicon suitepicon-action-select"></span></button><button type="button" name="btn_clr_{$fields.organizationalunit_name.name}" tabindex="0" title="{$APP.LBL_CLEAR_BUTTON_TITLE}" class="button lastChild" onclick="this.form.{$fields.organizationalunit_name.name}.value = \'\'; this.form.{$fields.organizationalunit_id.name}.value = \'\';" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"><span class="suitepicon suitepicon-action-clear"></span></button></span>',
               ),
               'phone_mobile',
            ),
            array(
