...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
    ...
    <tr>
        <td nowrap="nowrap" scope="row" width="200">{sugar_translate module='Currencies' label='CURRENCY_ON_RIGHT'}: </td>
        {if !empty($config.currency_on_right)}
            {assign var='currency_on_right_checked_locale' value=' checked'}
        {else}
            {assign var='currency_on_right_checked_locale' value=''}
        {/if}
        <td>
            <input type='hidden' name='currency_on_right' value='false'>
            <input type='checkbox' name='currency_on_right' value='true'{$currency_on_right_checked_locale} >
        </td>
    </tr>
