...
class Configurator {
   ...
   public function isConfirmOptInEnabled() {
      $confirmOptInEnabled = $this->getConfirmOptInEnumValue() === SugarEmailAddress::COI_STAT_CONFIRMED_OPT_IN;
   ...
   public function isOptInEnabled() {
      $confirmOptInEnabled = $this->getConfirmOptInEnumValue() === SugarEmailAddress::COI_STAT_OPT_IN;
