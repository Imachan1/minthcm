...
$mod_strings = array(
   ...
   'LBL_ADD_GANTT_ELEMENT' => 'Add',
   'LBL_CANCEL_GANTT_ELEMENT' => 'Cancel',
   'LBL_TASK_NAME_REQUIRED' => 'Task name is required',
   'LBL_START_DATE_REQUIRED' => 'Start date is required',
   'LBL_DURATION_REQUIRED' => 'Task duration is required',
   'LBL_DURATION_NOT_A_NUMBER' => 'Duration must be a number',
   'LBL_PERCENTAGE_REQUIRED' => 'Percentage of completion is required',
   'LBL_PERCENTAGE_NOT_A_NUMBER' => 'Percentage of completion must be a number',
   'LBL_PERCENTAGE_OVER_MAX' => 'Percentage of completion cannot go over 100',
);
