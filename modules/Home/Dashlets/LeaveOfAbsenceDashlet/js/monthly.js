   ...
   $.fn.extend( {
      monthly: function ( options ) {
         ...
         if ( options.weekStart == 'Sun' ) {
            ...
            $( '#' + uniqueId ).append( '<div class="monthly-day-title-wrap"><div>Pon</div><div>Wt</div><div>Śr</div><div>Czw</div><div>Pią</div><div>Sob</div><div>N</div></div><div class="monthly-day-wrap"></div>' );
         } else {
