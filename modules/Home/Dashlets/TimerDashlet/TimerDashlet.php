...
class TimerDashlet extends Dashlet {
    ...
    */
   //function TimerDashlet($id, $def) {
   public function __construct($id, $def) {
      $this->loadLanguage('TimerDashlet'); // load the language strings here
   ...
   public function display() {
      ...
      $str = $ss->fetch('modules/Home/Dashlets/TimerDashlet/TimerDashlet.tpl');
      $lbl = isset($this->dashletStrings['LBL_DBLCLICK_HELP']) ?
         $this->dashletStrings['LBL_DBLCLICK_HELP'] : '';
      return parent::display($lbl) . $str . '<br />'; // return parent::display for title and such
   }
   ...
   public function displayOptions() {
      ...
      $optTpl = 'modules/Home/Dashlets/TimerDashlet/TimerOptions.tpl';
      return parent::displayOptions($optTpl) . $ss->fetch();
   }
