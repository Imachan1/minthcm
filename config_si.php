<?php 
// http://dev.evolpe.net/MintHCM/MintHCM.git
...
$sugar_config_si = array (
            ...
            'export_delimiter' => ',',
            'setup_db_admin_password' => 't4jn3h4slo', // DATABASE ADMIN USER PASSWORD
            ...
            'setup_db_sugarsales_password' => 't4jn3h4slo', // THE DATABASE PASSWORD TO USE AFTER INSTALLATION TO CONNECT
            'setup_db_sugarsales_password_retype' => 't4jn3h4slo', // AGAIN
            ...
            'setup_db_database_name' => 'minthcm_'.strtolower(str_replace (['/var/www/','install','//'],'', getcwd())), // THE DATABASE NAME
            ...
            'setup_site_admin_password' => 't4jn3h4slo', // SUGAR ADMIN PASSWORD
            'setup_site_url' => 'http://localhost/'.str_replace (['/var/www/','install','//'],'', getcwd()), // PATH TO SUGAR INSTANCE VIA URL
            'setup_system_name' => 'MintHCM '.date('Y-m-d H:i'), // INSTANCE NAME
