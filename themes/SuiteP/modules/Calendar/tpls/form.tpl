...
<form id="CalendarEditView" name="CalendarEditView" method="POST">
    <!-- Mint begin -->
    <input type="hidden" name="current_module" id="current_module" value="WorkSchedules">
    ...
    <div>
        <!-- Mint begin -->
        {literal}
            <input type="radio" id="radio_meeting" value="Meetings" onclick="CAL.change_activity_type( this.value );" checked="false"  name="appttype" tabindex="100"/>
        {/literal}
        ...
        {literal}
            <input type="radio" id="radio_workschedule" value="WorkSchedules" onclick="CAL.change_activity_type( this.value );" checked="true"
                   name="appttype" tabindex="100"/>
        {/literal}
        <label for="radio_workschedule">{$MOD.LBL_CREATE_WORKSCHEDULE}</label>
