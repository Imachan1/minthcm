{*
** Mint #52883
** added data-forced property to dashboard tabs based on DMForced value from options
** changed javascript to be loaded from custom location
** Mint #58693
** APP -> app (invalid variable name)
*}
{*
/**
*
