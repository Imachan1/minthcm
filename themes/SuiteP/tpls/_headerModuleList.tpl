                                                                                            ...
                                                                                            <div class="mobile-bar">
                                                                                                <ul id="toolbar" class="toolbar">
                                                                                                    <li id="quickcreatetop" class="create dropdown nav navbar-nav quickcreatetop">
                                                                                                        ...
                                                                                                        <ul class="dropdown-menu" role="menu">
                                                                                                            {* View Tools START #51289, Mint #62602 *}
                                                                                                            <li><a href="index.php?module=Ideas&action=EditView&return_module=Ideas&return_action=DetailView">{sugar_translate module="Ideas" label="LBL_NEW_FORM_TITLE"}</a></li>
                                                                                                            <li><a href="index.php?module=Notes&action=EditView&return_module=Notes&return_action=DetailView">{sugar_translate module="Notes" label="LBL_NEW_FORM_TITLE"}</a></li>
                                                                                                            ...
                                                                                                            <li><a href="index.php?module=Meetings&action=EditView&return_module=Meetings&return_action=DetailView">{sugar_translate module="Meetings" label="LBL_NEW_FORM_TITLE"}</a></li>
                                                                                                            <li><a href="index.php?module=Reservations&action=EditView&return_module=Reservations&return_action=DetailView">{sugar_translate module="Reservations" label="LBL_NEW_FORM_TITLE"}</a></li>
                                                                                                            <li><a href="index.php?module=WorkSchedules&action=EditView&return_module=WorkSchedules&return_action=DetailView">{sugar_translate module="WorkSchedules" label="LBL_NEW_FORM_TITLE"}</a></li>
