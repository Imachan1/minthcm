...
<div align="right" id="dashletSearch">
    <table>
        <tr>
            <td>{sugar_translate label='LBL_DASHLET_SEARCH' module='Home'}: <input id="search_string" type="text" length="15" onKeyPress="javascript:if ( event.keyCode == 13 )
                      SUGAR.mySugar.searchDashlets( this.value, document.getElementById( 'search_category' ).value );"  title="{sugar_translate label='LBL_DASHLET_SEARCH' module='Home'}"/>
...
{if $moduleName == 'Home'}
    <ul class="subpanelTablist" id="dashletCategories">
        ...
        <li id="chartCategory" style="display: none"><a href="javascript:SUGAR.mySugar.toggleDashletCategories('chart');" class="" id="chartCategoryAnchor"><span class="suitepicon suitepicon-dashlet-charts-groupby"></span>{sugar_translate label='LBL_CHARTS' module='Home'}</a></li>
        ...
        <div id="webDashletsList">
            <table width="95%">
                <tr>
                    ...
                    <td>
                        <input type="text" id="web_address" value="https://" style="width: 400px"   title="{sugar_translate label='LBL_WEBSITE_TITLE' module='Home'}"/>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="rss_address" value="https://" style="width: 400px"  title="{sugar_translate label='LBL_RSS_TITLE' module='Home'}" />
