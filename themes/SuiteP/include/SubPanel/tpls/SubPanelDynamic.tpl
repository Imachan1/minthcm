...
*/
*}
{* View Tools start #36866 #40449 #59582 *}
<script>viewTools.GUI.setCountOfSubpanel( '{$SUBPANEL_ID}', {$COUNT_OF_ROWS}, {$LIMITED_COUNT} );</script>
{* View Tools end #36866 #40449 #59582 *}
