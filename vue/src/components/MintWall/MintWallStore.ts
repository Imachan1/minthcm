...
export const useMintWallStore = (key = 'mint') =>
    defineStore(`wall-${key}`, () => {
        ...
        async function loadNews() {
            ...
            newsList.value = []
            const apiResponse = await mintApi.get('api/News/drawer/list')
            if (apiResponse.data) {
        ...
        async function reactToNews(id: string, reactionType: string) {
            ...
            await mintApi.post(`api/reactions/News/${id}`, {
        ...
        async function deleteNewsReaction(id: string) {
            ...
            await mintApi.delete(`api/Reactions/${id}`)
        }
        ...
        async function readNewsAlerts(newsId: string) {
            ...
            const result = await mintApi.patch('api/News/update/readAlerts', { news_id: newsId })
