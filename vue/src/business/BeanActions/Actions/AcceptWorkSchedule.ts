...
export class AcceptWorkSchedule extends BeanAction {
    public static readonly TITLE = 'LBL_ACCEPT_WORK_PLAN_BTN'
    public static readonly ICON = 'mdi-check-bold'
    public static readonly ACL = ['edit']

    public isAvailable(): boolean {
        return super.isAvailable() 
            && ['WorkSchedules'].includes(this.bean.module) 
            && ['wait'].includes(this.bean.attributes.supervisor_acceptance)
