 ...
 * @ORM\Index(name="skillspk", columns={"id"})})
 */
// Auto-generated SectionRepository section end
class Skills extends MintEntity
{
...
// Auto-generated SectionProperties section start
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="skills")
     */
     ...
     * @ORM\ManyToOne(targetEntity=Employees::class, inversedBy="skills")
     */
    ...
    /**
     * @ORM\JoinTable(name="skills_competencies")
     * @ORM\ManyToMany(targetEntity=Competencies::class, mappedBy="skills")
     */
