...
/**
 * @ORM\Entity
 * @ORM\Table(name="reservations", indexes={
 * @ORM\Index(name="reservationspk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
...
class Reservations extends MintEntity
{
...
// Auto-generated SectionProperties section start
     ...
     * @ORM\ManyToOne(targetEntity=Employees::class, inversedBy="reservations")
     */
    protected $employee_link;

    /**
     * @ORM\JoinColumn(name="resource_id", referencedColumnName="id")
     * @ORM\ManyToOne(targetEntity=Resources::class, inversedBy="reservations")
     */
    protected $resources;

    /**
     * @ORM\JoinColumn(name="delegation_id", referencedColumnName="id")
     * @ORM\ManyToOne(targetEntity=Delegations::class, inversedBy="reservations")
     */
