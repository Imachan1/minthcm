...
/**
 * @ORM\Entity
 * @ORM\Table(name="offboardings", indexes={
 * @ORM\Index(name="offboardingspk", columns={"id"})})
 */
...
// Auto-generated SectionProperties section start
     ...
     * @ORM\ManyToOne(targetEntity=Employees::class, inversedBy="offboardings")
     */
     ...
     * @ORM\ManyToOne(targetEntity=OffboardingTemplates::class, inversedBy="offboardings")
     */
