...
/**
 * @ORM\Entity
 * @ORM\Table(name="delegationslocale", indexes={
 * @ORM\Index(name="delegationslocalepk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $archival
 */
// Auto-generated SectionRepository section end
class DelegationsLocale extends MintEntity
{
...
// Auto-generated SectionProperties section start
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="delegationslocale")
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity=Delegations::class, mappedBy="delegationslocale")
     */
