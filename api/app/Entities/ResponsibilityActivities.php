 ...
 * @ORM\Index(name="responsibilityactivitiespk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
...
class ResponsibilityActivities extends MintEntity
{
...
// Auto-generated SectionProperties section start
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="responsibilityactivities")
     */
