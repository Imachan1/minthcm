...
/**
 * @ORM\Entity
 * @ORM\Table(name="conclusions", indexes={
 * @ORM\Index(name="conclusionspk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
...
class Conclusions extends MintEntity
{
...
// Auto-generated SectionProperties section start
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="conclusions")
     */
     ...
     * @ORM\ManyToOne(targetEntity=Employees::class, inversedBy="conclusions")
     */
    protected $employee_link;

    /**
     * @ORM\JoinColumn(name="meeting_id", referencedColumnName="id")
     * @ORM\ManyToOne(targetEntity=Meetings::class, inversedBy="conclusions")
     */
    protected $meetings;

    /**
     * @ORM\JoinTable(name="conclusions_improvements")
     * @ORM\ManyToMany(targetEntity=Improvements::class, mappedBy="conclusions")
     */
    protected Collection $improvements;

    /**
     * @ORM\JoinTable(name="conclusions_problems")
     * @ORM\ManyToMany(targetEntity=Problems::class, mappedBy="conclusions")
     */
    ...
    public function __construct()
    {
        ...
        $this->improvements = new ArrayCollection();
