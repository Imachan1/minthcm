...
/**
 * @ORM\Entity
 * @ORM\Table(name="goals", indexes={
 * @ORM\Index(name="goalspk", columns={"id"})})
 */
// Auto-generated SectionRepository section end
class Goals extends MintEntity
{
...
// Auto-generated SectionProperties section start
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="goals")
     */
     ...
     * @ORM\ManyToOne(targetEntity=Employees::class, inversedBy="goals")
     */
