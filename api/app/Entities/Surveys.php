...
/**
 * @ORM\Entity
 * @ORM\Table(name="surveys", indexes={
 * @ORM\Index(name="surveyspk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $submit_text
 * @property mixed $satisfied_text
 * @property mixed $neither_text
 * @property mixed $dissatisfied_text
 */
...
// Auto-generated SectionProperties section start
     ...
     * @ORM\Column(type="string")
     */
    protected $satisfied_text;

    /**
     * @ORM\Column(type="string")
     */
    protected $neither_text;

    /**
     * @ORM\Column(type="string")
     */
    protected $dissatisfied_text;

    /**
     * @ORM\JoinColumn(name="modified_user_id", referencedColumnName="id")
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="surveys")
     */
