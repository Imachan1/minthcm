...
/**
 * @ORM\Entity
 * @ORM\Table(name="achievements", indexes={
 * @ORM\Index(name="achievementspk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $award_type
 * @property mixed $visibility
 * @property mixed $active
 */
// Auto-generated SectionRepository section end
class Achievements extends MintEntity
{
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="achievements")
     */
