...
/**
 * @ORM\Entity
 * @ORM\Table(name="attitudes", indexes={
 * @ORM\Index(name="attitudespk", columns={"id"})})
 */
// Auto-generated SectionRepository section end
class Attitudes extends MintEntity
{
...
// Auto-generated SectionProperties section start
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="attitudes")
     */
     ...
     * @ORM\ManyToOne(targetEntity=Employees::class, inversedBy="attitudes")
     */
    ...
    /**
     * @ORM\JoinTable(name="attitudes_competencies")
     * @ORM\ManyToMany(targetEntity=Competencies::class, mappedBy="attitudes")
     */
