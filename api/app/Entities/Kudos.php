 ...
 * @ORM\Table(name="kudos", indexes={
 * @ORM\Index(name="kudospk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $announced
 * @property mixed $announcement_date
...
// Auto-generated SectionProperties section start
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="kudos")
     */
     ...
     * @ORM\ManyToOne(targetEntity=Employees::class, inversedBy="kudos")
     */
