 ...
 * @ORM\Index(name="certificatespk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $attempts_number
 * @property mixed $duration
 * @property mixed $pass_rate
 */
// Auto-generated SectionRepository section end
class Certificates extends MintEntity
{
...
// Auto-generated SectionProperties section start
    ...
    /**
     * @ORM\JoinTable(name="documents_certificates", joinColumns={@ORM\JoinColumn(name="certificate_id", referencedColumnName="id")}, inverseJoinColumns={@ORM\JoinColumn(name="document_id", referencedColumnName="id")})
     * @ORM\ManyToMany(targetEntity=Documents::class, inversedBy="certificates")
     */
    protected Collection $documents;

    /**
     * @ORM\JoinTable(name="certificates_trainings", joinColumns={@ORM\JoinColumn(name="certificates_id", referencedColumnName="id")}, inverseJoinColumns={@ORM\JoinColumn(name="trainings_id", referencedColumnName="id")})
     * @ORM\ManyToMany(targetEntity=Trainings::class, inversedBy="certificates")
     */
    protected Collection $trainings;

    /**
     * @ORM\OneToMany(targetEntity=EmployeeCertificates::class, mappedBy="certificates")
     */
