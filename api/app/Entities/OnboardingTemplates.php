...
/**
 * @ORM\Entity
 * @ORM\Table(name="onboardingtemplates", indexes={
 * @ORM\Index(name="onboardingtemplatespk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
...
// Auto-generated SectionProperties section start
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="onboardingtemplates")
     */
    ...
    /**
     * @ORM\OneToMany(targetEntity=Positions::class, mappedBy="onboardingtemplates")
     */
     ...
     */
    protected Collection $onboardings;

    /**
     * @ORM\JoinTable(name="onboardingoffboardingelements_onboardingtemplates", joinColumns={@ORM\JoinColumn(name="onboardingtemplates_id", referencedColumnName="id")}, inverseJoinColumns={@ORM\JoinColumn(name="onboardingoffboardingelements_id", referencedColumnName="id")})
     * @ORM\ManyToMany(targetEntity=OnboardingOffboardingElements::class, inversedBy="onboardingtemplates")
     */
