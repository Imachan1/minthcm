...
/**
 * @ORM\Entity
 * @ORM\Table(name="onboardings", indexes={
 * @ORM\Index(name="onboardingspk", columns={"id"})})
 */
...
// Auto-generated SectionProperties section start
     ...
     * @ORM\ManyToOne(targetEntity=Employees::class, inversedBy="onboardings")
     */
     ...
     * @ORM\ManyToOne(targetEntity=OnboardingTemplates::class, inversedBy="onboardings")
     */
