 ...
 * @ORM\Index(name="exitinterviewspk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
...
// Auto-generated SectionProperties section start
     ...
     * @ORM\ManyToOne(targetEntity=Employees::class, inversedBy="exitinterviews")
     */
    ...
    /**
     * @ORM\JoinColumn(name="offboarding_id", referencedColumnName="id")
     * @ORM\ManyToOne(targetEntity=Offboardings::class, inversedBy="exitinterviews")
     */
    protected $offboarding;

    /**
     * @ORM\JoinTable(name="exitinterviews_meetings")
     * @ORM\ManyToMany(targetEntity=Meetings::class, mappedBy="exitinterviews")
     */
    protected Collection $meetings;

    /**
     * @ORM\JoinTable(name="exitinterviews_documents")
     * @ORM\ManyToMany(targetEntity=Documents::class, mappedBy="exitinterviews")
     */
