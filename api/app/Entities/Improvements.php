...
/**
 * @ORM\Entity
 * @ORM\Table(name="improvements", indexes={
 * @ORM\Index(name="improvementspk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
...
class Improvements extends MintEntity
{
...
// Auto-generated SectionProperties section start
     ...
     * @ORM\ManyToOne(targetEntity=Users::class, inversedBy="improvements")
     */
     ...
     * @ORM\ManyToOne(targetEntity=Employees::class, inversedBy="improvements")
     */
    protected $employee_link;

    /**
     * @ORM\JoinTable(name="conclusions_improvements", joinColumns={@ORM\JoinColumn(name="improvement_id", referencedColumnName="id")}, inverseJoinColumns={@ORM\JoinColumn(name="conclusion_id", referencedColumnName="id")})
     * @ORM\ManyToMany(targetEntity=Conclusions::class, inversedBy="improvements")
     */
