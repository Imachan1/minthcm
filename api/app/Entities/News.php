 ...
 * @ORM\Index(name="newspk", columns={"id"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $content_of_announcement
 * @property mixed $display_date
 * @property mixed $news_type
 * @property mixed $news_status
...
// Auto-generated SectionProperties section start
     ...
     * @ORM\Column(type="text")
     */
    protected $content_of_announcement;
    ...
    /**
     * @ORM\OneToMany(targetEntity=Reactions::class, mappedBy="news")
     */
    protected Collection $reactions;

    /**
     * @ORM\OneToMany(targetEntity=UsersNews::class, mappedBy="news")
     */
    protected Collection $usersnews;

    /**
     * @ORM\JoinTable(name="prospect_list_news")
     * @ORM\ManyToMany(targetEntity=ProspectLists::class, mappedBy="news")
     */
