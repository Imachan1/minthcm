 ...
 * @property mixed $work_date
 * @property mixed $spent_time
 * @property mixed $done_ratio
 * @property mixed $remaining_hours
 * @property mixed $current_done_ratio
 * @property mixed $current_remaining_hours
 * @property mixed $estimated_task_time
 * @property mixed $worked_task_time
 * @property mixed $employee_id
 * @property mixed $type
 * @property mixed $category
 * @property mixed $organizational_unit
 */
...
// Auto-generated SectionProperties section start
     ...
     * @ORM\Column(type="string", length="255")
     */
    protected $done_ratio;

    /**
     * @ORM\Column(type="float")
     */
    protected $remaining_hours;

    /**
     * @ORM\Column(type="integer", length="255")
     */
    protected $current_done_ratio;

    /**
     * @ORM\Column(type="float")
     */
    protected $current_remaining_hours;

    /**
     * @ORM\Column(type="float")
     */
    protected $estimated_task_time;

    /**
     * @ORM\Column(type="float")
     */
    protected $worked_task_time;
