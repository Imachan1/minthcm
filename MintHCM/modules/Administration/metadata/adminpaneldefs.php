...
$admin_option_defs['Users']['roles_management'] = ['Roles', 'LBL_MANAGE_ROLES_TITLE', 'LBL_MANAGE_ROLES', './index.php?module=ACLRoles&action=index', 'roles'];
$admin_option_defs['Administration']['password_management'] = ['Password', 'LBL_MANAGE_PASSWORD_TITLE', 'LBL_MANAGE_PASSWORD', './index.php?module=Administration&action=PasswordManager', 'password'];
...
//system.
$admin_option_defs = [];
$admin_option_defs['Administration']['configphp_settings'] = ['Administration', 'LBL_CONFIGURE_SETTINGS_TITLE', 'LBL_CONFIGURE_SETTINGS', './index.php?module=Configurator&action=EditView', 'system-settings'];
$admin_option_defs['Administration']['import'] = ['Import', 'LBL_IMPORT_WIZARD', 'LBL_IMPORT_WIZARD_DESC', './index.php?module=Import&action=step1&import_module=Administration', 'import'];
$admin_option_defs['Administration']['locale'] = ['Currencies', 'LBL_MANAGE_LOCALE', 'LBL_LOCALE', './index.php?module=Administration&action=Locale&view=default', 'locale'];

if (!defined('TEMPLATE_URL')) {
    $admin_option_defs['Administration']['upgrade_wizard'] = ['Upgrade', 'LBL_UPGRADE_WIZARD_TITLE', 'LBL_UPGRADE_WIZARD', './index.php?module=UpgradeWizard&action=index', 'upgrade-wizard'];
}

$admin_option_defs['Administration']['currencies_management'] = ['Currencies', 'LBL_MANAGE_CURRENCIES', 'LBL_CURRENCY', './index.php?module=Currencies&action=index', 'currencies'];

if (!isset($GLOBALS['sugar_config']['hide_admin_backup']) || !$GLOBALS['sugar_config']['hide_admin_backup']) {
    $admin_option_defs['Administration']['backup_management'] = ['Backups', 'LBL_BACKUPS_TITLE', 'LBL_BACKUPS', './index.php?module=Administration&action=Backups', 'backups'];
}

$admin_option_defs['Administration']['languages'] = ['Currencies', 'LBL_MANAGE_LANGUAGES', 'LBL_LANGUAGES', './index.php?module=Administration&action=Languages&view=default', 'languages'];

$admin_option_defs['Administration']['repair'] = ['Repair', 'LBL_UPGRADE_TITLE', 'LBL_UPGRADE', './index.php?module=Administration&action=Upgrade', 'repair'];

if (!isset($GLOBALS['sugar_config']['hide_admin_diagnostics']) || !$GLOBALS['sugar_config']['hide_admin_diagnostics']) {
    $admin_option_defs['Administration']['diagnostic'] = ['Diagnostic', 'LBL_DIAGNOSTIC_TITLE', 'LBL_DIAGNOSTIC_DESC', './index.php?module=Administration&action=Diagnostic', 'diagnostic'];
}

// Connector Integration
$admin_option_defs['Administration']['connector_settings'] = ['icon_Connectors', 'LBL_CONNECTOR_SETTINGS', 'LBL_CONNECTOR_SETTINGS_DESC', './index.php?module=Connectors&action=ConnectorSettings', 'connectors'];

// Theme Enable/Disable
$admin_option_defs['Administration']['theme_settings'] = ['icon_AdminThemes', 'LBL_THEME_SETTINGS', 'LBL_THEME_SETTINGS_DESC', './index.php?module=Administration&action=ThemeSettings', 'themes'];

$admin_option_defs['Administration']['scheduler'] = ['Schedulers', 'LBL_SUITE_SCHEDULER_TITLE', 'LBL_SUITE_SCHEDULER', './index.php?module=Schedulers&action=index', 'scheduler'];

$admin_option_defs['Administration']['feed_settings'] = ['icon_SugarFeed', 'LBL_SUITEFEED_SETTINGS', 'LBL_SUITEFEED_SETTINGS_DESC', './index.php?module=SugarFeed&action=AdminSettings', 'activity-streams'];

require_once 'include/SugarOAuthServer.php';
if (SugarOAuthServer::enabled()) {
    $admin_option_defs['Administration']['oauth_keys'] = ['Password', 'LBL_OAUTH_TITLE', 'LBL_OAUTH', './index.php?module=OAuthKeys&action=index', 'oauth-keys'];
}

$admin_option_defs['Administration']['oauth2_clients'] = ['Password', 'LBL_OAUTH2_CLIENTS_TITLE', 'LBL_OAUTH2_CLIENTS', './index.php?module=OAuth2Clients&action=index', 'password'];
...
$admin_option_defs['Campaigns']['mass_Email'] = ['EmailQueue', 'LBL_MASS_EMAIL_MANAGER_TITLE', 'LBL_MASS_EMAIL_MANAGER_DESC', './index.php?module=EmailMan&action=index', 'email-queue'];

$admin_group_header[] = ['LBL_EMAIL_TITLE', '', false, $admin_option_defs, 'LBL_EMAIL_DESC'];

//studio.
$admin_option_defs = [];
$admin_option_defs['studio']['studio'] = ['Studio', 'LBL_STUDIO', 'LBL_STUDIO_DESC', './index.php?module=ModuleBuilder&action=index&type=studio', 'studio'];
if (isset($GLOBALS['beanFiles']['iFrame'])) {
    $admin_option_defs['Administration']['portal'] = ['iFrames', 'LBL_IFRAME', 'DESC_IFRAME', './index.php?module=iFrames&action=index'];
}
$admin_option_defs['Administration']['rename_tabs'] = ['RenameTabs', 'LBL_RENAME_TABS', 'LBL_CHANGE_NAME_MODULES', "./index.php?action=wizard&module=Studio&wizard=StudioWizard&option=RenameTabs", 'rename-modules'];
$admin_option_defs['Administration']['moduleBuilder'] = ['ModuleBuilder', 'LBL_MODULEBUILDER', 'LBL_MODULEBUILDER_DESC', './index.php?module=ModuleBuilder&action=index&type=mb', 'module-builder'];
$admin_option_defs['Administration']['history_contacts_emails'] = ['ConfigureTabs', 'LBL_HISTORY_CONTACTS_EMAILS', 'LBL_HISTORY_CONTACTS_EMAILS_DESC', './index.php?module=Configurator&action=historyContactsEmails', 'history-subpanel'];
$admin_option_defs['Administration']['configure_tabs'] = ['ConfigureTabs', 'LBL_CONFIGURE_TABS_AND_SUBPANELS', 'LBL_CONFIGURE_TABS_AND_SUBPANELS_DESC', './index.php?module=Administration&action=ConfigureTabs', 'display-modules-and-subpanels'];
$admin_option_defs['Administration']['module_loader'] = ['ModuleLoader', 'LBL_MODULE_LOADER_TITLE', 'LBL_MODULE_LOADER', './index.php?module=Administration&action=UpgradeWizard&view=module', 'module-loader'];

$admin_option_defs['Administration']['configure_group_tabs'] = ['ConfigureTabs', 'LBL_CONFIGURE_GROUP_TABS', 'LBL_CONFIGURE_GROUP_TABS_DESC', './index.php?action=wizard&module=Studio&wizard=StudioWizard&option=ConfigureGroupTabs', 'configure-module-menu-filters'];
...
$admin_option_defs = [];
$admin_option_defs['Administration']['securitygroup_management'] = ['SecuritySuiteGroupManagement', 'LBL_MANAGE_SECURITYGROUPS_TITLE', 'LBL_MANAGE_SECURITYGROUPS', './index.php?module=SecurityGroups&action=index', 'security'];
$admin_option_defs['Administration']['securitygroup_config'] = ['SecurityGroupsManagement', 'LBL_CONFIG_SECURITYGROUPS_TITLE', 'LBL_CONFIG_SECURITYGROUPS', './index.php?module=SecurityGroups&action=config', 'security-suite-group-management'];
...
if (empty($GLOBALS['sugar_config']['minthcm_cloud'])) { // MintHCM #62039
...
$admin_option_defs = [];
$admin_option_defs['Administration']['DashboardManager'] = array(
    'DashboardManager',
