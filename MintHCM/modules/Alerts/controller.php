...
class AlertsController extends SugarController
{
    public function action_get()
    {
        ...
        $this->view_object_map['Results'] = $bean->get_full_list("alerts.date_entered", "alerts.assigned_user_id = '" . $current_user->id . "' AND is_read != '1' AND parent_type NOT IN (" . $disabled_modules_string_with_quotes . ")");
