 ...
 */
class OnboardingTemplates extends Basic
{

    public $new_schema = true;
    public $module_dir = 'OnboardingTemplates';
    public $object_name = 'OnboardingTemplates';
    public $table_name = 'onboardingtemplates';
