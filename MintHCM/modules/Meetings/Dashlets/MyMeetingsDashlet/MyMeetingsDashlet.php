...
class MyMeetingsDashlet extends DashletGeneric
{
    ...
    public function __construct($id, $def = null)
    {
        ...
        $this->searchFields = $dashletData['MeetingsDashlet']['searchFields'];
        ...
        $this->columns = $dashletData['MeetingsDashlet']['columns'];
    ...
    public function process($lvsParams = array(), $id = null)
    {
        ...
        foreach ($this->lvs->data['data'] as $rowNum => $row) {
            ...
            // eVolpe MyMeetingsDashlet_hotfix START
            // if (!empty($this->lvs->data['data'][$rowNum]['STATUS']) && $this->lvs->data['data'][$rowNum]['STATUS'] == $app_list_strings['meeting_status_dom']['Planned']) {
            if (!empty($this->lvs->data['data'][$rowNum]['STATUS']) && 'Planned' == $this->lvs->data['data'][$rowNum]['STATUS']) {
            // eVolpe MyMeetingsDashlet_hotfix END
