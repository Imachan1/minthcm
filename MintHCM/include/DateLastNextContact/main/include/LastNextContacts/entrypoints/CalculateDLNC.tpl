...
<head>
    ...
    <script type='text/javascript' src='{sugar_getjspath file="custom/include/LastNextContacts/entrypoints/CalculateDLNC.js"}' defer></script>
    {* <script type='text/javascript' src='custom/include/LastNextContacts/entrypoints/CalculateDLNC.js' defer></script> *}
    {literal}
    <style type="text/css">
        *,
        *::before,
        ...
        <div class="section">
            <div class="form">
                <select id="module_name">
                    <option value="accounts">{$lang.LBL_CALCULATE_DLNC_ACCOUNTS}</option>
                    <option value="contacts">{$lang.LBL_CALCULATE_DLNC_CONTACTS}</option>
                    <option value="leads">{$lang.LBL_CALCULATE_DLNC_LEADS}</option>
                </select>
