...
class SugarWidgetSubPanelTopSelectButtonForOnboardingTemplates extends SugarWidgetSubPanelTopSelectButton {
   ...
   public function display($widget_data, $additionalFormFields = NULL, $nonbutton = false) {
      ...
      return ' <input type="button" name="' . $this->getWidgetId() . '" id="' . $this->getWidgetId() . '" class="button"' . "\n"
         . ' title="' . $this->title . '"'
         . ' value="' . $this->value . "\"\n"
         . " onclick='open_popup(\"$this->module_name\",600,400,\"$initial_filter\",true,true,$json_encoded_php_array,\"$popup_mode\",$create,\"popupforonboardingtemplatesdefs\");' />\n";
   }
