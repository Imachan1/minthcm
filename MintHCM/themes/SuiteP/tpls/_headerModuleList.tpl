                                                                                                ...
                                                                                                <ul id="toolbar" class="toolbar">
                                                                                                    <li id="quickcreatetop" class="create dropdown nav navbar-nav quickcreatetop">
                                                                                                        ...
                                                                                                        <ul class="dropdown-menu" role="menu">
                                                                                                            ...
                                                                                                            <li><a href="index.php?module=Ideas&action=EditView&return_module=Ideas&return_action=DetailView">{sugar_translate module="Ideas" label="LBL_LIST_TITLE"}</a></li>
                                                                                                            <li><a href="index.php?module=Notes&action=EditView&return_module=Notes&return_action=DetailView">{sugar_translate module="Notes" label="LBL_LIST_TITLE"}</a></li>
                                                                                                            <li><a href="index.php?module=Reservations&action=EditView&return_module=Reservations&return_action=DetailView">{sugar_translate module="Reservations" label="LBL_LIST_TITLE"}</a></li>
                                                                                                            <li><a href="index.php?module=WorkSchedules&action=EditView&return_module=WorkSchedules&return_action=DetailView">{sugar_translate module="WorkSchedules" label="LBL_LIST_TITLE"}</a></li>
                                                                                                            <li><a href="index.php?module=Appraisals&action=EditView&return_module=Appraisals&return_action=DetailView">{sugar_translate module="Appraisals" label="LBL_LIST_TITLE"}</a></li>
