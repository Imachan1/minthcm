...
return CustomLoader::mergeCustomArray([
    ...
    Controller\CalendarDataController::class => function (Container $container) {
        return new Controller\CalendarDataController(
            $container->get(CalendarDataService::class)
        );
    },
], basename(__FILE__));
